...
import com.smi.declarations.services.TrService.TrDivService;
import com.smi.declarations.services.XsdValidator;
import com.smi.generated.tr_div.Document;
...
@RestController
@RequestMapping("/api/tr-div")
public class TrDivController {

    @Autowired
    private TrDivService trDivService;
    ...
    public ResponseEntity<?> convertExcelToXml(
        ...
        try {
            ...
            Document document = trDivService.processExcelFile(excelFile);
