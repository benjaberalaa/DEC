...
import com.smi.declarations.services.CrsService.CrsNegService;
import com.smi.declarations.services.XsdValidator;
import com.smi.generated.crs_neg.Document;
...
@RestController
@RequestMapping("/api/crs-neg")
public class CrsNegController {

    @Autowired
    private CrsNegService crsNegService;
    ...
    public ResponseEntity<?> convertExcelToXml(
        ...
        try {
            ...
            Document document = crsNegService.processExcelFile(excelFile);
