...
import com.smi.declarations.services.DsService.DsIetrService;
import com.smi.declarations.services.XsdValidator;
import com.smi.generated.ds_ietr.Document;
...
@RestController
@RequestMapping("/api/ds-ietr")
public class DsIetrController {

    @Autowired
    private DsIetrService dsIetrService;
    ...
    public ResponseEntity<?> convertExcelToXml(
        ...
        try {
            ...
            Document document = dsIetrService.processExcelFile(excelFile);
