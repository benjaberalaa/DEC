...
import com.smi.declarations.services.DsService.DsStartupIeTrService;
import com.smi.declarations.services.XsdValidator;
import com.smi.generated.ds_stratup_ie_tr.Document;
...
@RestController
@RequestMapping("/api/ds-startup-ie-tr")
public class DsStartupIeTrController {

    @Autowired
    private DsStartupIeTrService dsStartupIeTrService;
    ...
    public ResponseEntity<?> convertExcelToXml(
        ...
        try {
            ...
            Document document = dsStartupIeTrService.processExcelFile(excelFile);
