...
import com.smi.declarations.services.TrService.TrScService;
import com.smi.declarations.services.XsdValidator;
import com.smi.generated.tr_sc.Document;
...
@RestController
@RequestMapping("/api/tr-sc")
public class TrScController {

    @Autowired
    private TrScService trScService;
    ...
    public ResponseEntity<?> convertExcelToXml(
        ...
        try {
            ...
            Document document = trScService.processExcelFile(excelFile);
