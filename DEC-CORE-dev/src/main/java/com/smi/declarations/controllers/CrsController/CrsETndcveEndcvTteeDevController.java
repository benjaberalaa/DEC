...
import com.smi.declarations.services.CrsService.CrsETndcveEndcvTteeDevService;
import com.smi.declarations.services.XsdValidator;
import com.smi.generated.crs_e_tndcve_endcv_ttee_dev.Document;
...
@RestController
@RequestMapping("/api/crs-etndcve-endcv-ttee-dev")
public class CrsETndcveEndcvTteeDevController {

    @Autowired
    private CrsETndcveEndcvTteeDevService service;
    ...
    public ResponseEntity<?> convertExcelToXml(
        ...
        try {
            ...
            Document document = service.processExcelFile(excelFile);
