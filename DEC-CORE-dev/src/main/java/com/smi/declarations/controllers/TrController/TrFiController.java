...
import com.smi.declarations.services.TrService.TrFiService;
import com.smi.declarations.services.XsdValidator;
import com.smi.generated.tr_fi_v2.Document;
...
@RestController
@RequestMapping("/api/tr-fi")
public class TrFiController {

    @Autowired
    private TrFiService trFiService;
    ...
    public ResponseEntity<?> convertExcelToXml(
        ...
        try {
            ...
            Document document = trFiService.processExcelFile(excelFile);
