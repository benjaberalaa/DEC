...
import com.smi.declarations.services.TrService.TrIeService;
import com.smi.declarations.services.XsdValidator;
import com.smi.generated.tr_ie.Document;
...
public class TrIeController {
    ...
    public ResponseEntity<?> convertExcelToXml(
        ...
        try {
            ...
            Document document = trIeService.processExcelFile(excelFile);
