...
import com.smi.declarations.services.CrsService.CrsInrService;
import com.smi.declarations.services.XsdValidator;
import com.smi.generated.crs_inr.Document;
...
@RestController
@RequestMapping("/api/crs-inr")
public class CrsInrController {

    @Autowired
    private CrsInrService crsInrService;
    ...
    public ResponseEntity<?> convertExcelToXml(
        ...
        try {
            ...
            Document document = crsInrService.processExcelFile(excelFile);
