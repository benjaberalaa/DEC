...
import com.smi.declarations.services.TrService.TrRdService;
import com.smi.declarations.services.XsdValidator;
import com.smi.generated.majc_tr_rd_v3.Document;
...
@RestController
@RequestMapping("/api/tr-rd")
public class TrRdController {

    @Autowired
    private TrRdService trRdService;
    ...
    public ResponseEntity<?> convertExcelToXml(
        ...
        try {
            ...
            Document document = trRdService.processExcelFile(excelFile);
