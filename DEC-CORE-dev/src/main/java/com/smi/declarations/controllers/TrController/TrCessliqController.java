...
import com.smi.declarations.services.TrService.TrCessliqService;
import com.smi.declarations.services.XsdValidator;
import com.smi.generated.tr_cessliq_v2.Document;
...
@RestController
@RequestMapping("/api/tr-cessliq")
public class TrCessliqController {

    @Autowired
    private TrCessliqService trCessliqService;
    ...
    public ResponseEntity<?> convertExcelToXml(
        ...
        try {
            ...
            Document document = trCessliqService.processExcelFile(excelFile);
