...
import com.smi.declarations.services.CrsService.CrsAllTndCvService;
import com.smi.declarations.services.XsdValidator;
import com.smi.generated.crs_all_tndcv.Document;
...
@RestController
@RequestMapping("/api/crs-all-tnd-cv")
public class CrsAllTndCvController {

    @Autowired
    private CrsAllTndCvService crsAllTndCvService;
    ...
    public ResponseEntity<?> convertExcelToXml(
        ...
        try {
            ...
            Document document = crsAllTndCvService.processExcelFile(excelFile);
