...
import com.smi.declarations.services.TrService.TrAllCtiService;
import com.smi.declarations.services.XsdValidator;
import com.smi.generated.tr_all_cti.Document;
...
@RestController
@RequestMapping("/api/tr-all-cti")
public class TrAllCtiController {

    @Autowired
    private TrAllCtiService trAllCtiService;
    ...
    public ResponseEntity<?> convertExcelToXml(
        ...
        try {
            ...
            Document document = trAllCtiService.processExcelFile(excelFile);
