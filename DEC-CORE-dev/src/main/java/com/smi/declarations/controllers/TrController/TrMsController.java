...
import com.smi.declarations.services.TrService.TrMsService;
import com.smi.declarations.services.XsdValidator;
import com.smi.generated.tr_ms.Document;
...
@RestController
@RequestMapping("/api/tr-ms")
public class TrMsController {

    @Autowired
    private TrMsService trMsService;
    ...
    public ResponseEntity<?> convertExcelToXml(
        ...
        try {
            ...
            Document document = trMsService.processExcelFile(excelFile);
