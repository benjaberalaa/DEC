...
import com.smi.declarations.services.TrService.TrDomEeService;
import com.smi.declarations.services.XsdValidator;
import com.smi.generated.tr_dom_ee.Document;
...
@RestController
@RequestMapping("/api/tr-domee")
public class TrDomEeController {

    @Autowired
    private TrDomEeService trDomEeService;
    ...
    public ResponseEntity<?> convertExcelToXml(
        ...
        try {
            ...
            Document document = trDomEeService.processExcelFile(excelFile);
