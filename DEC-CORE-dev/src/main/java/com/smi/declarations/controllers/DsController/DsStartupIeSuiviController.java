package com.smi.declarations.controllers.DsController;

import com.smi.declarations.services.DsService.DsStartupIeSuiviService;
import com.smi.declarations.services.XsdValidator;
import com.smi.generated.ds_startup_ie_suivi.Document;
...
@RestController
@RequestMapping("/api/ds-startup-ie-suivi")
public class DsStartupIeSuiviController {

    @Autowired
    private DsStartupIeSuiviService dsStartupIeSuiviService;
    ...
    public ResponseEntity<?> convertExcelToXml(
        ...
        try {
            ...
            Document document = dsStartupIeSuiviService.processExcelFile(excelFile);
