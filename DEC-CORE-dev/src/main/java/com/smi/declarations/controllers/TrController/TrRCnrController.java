...
import com.smi.declarations.services.TrService.TrRCnrService;
...
@RestController
@RequestMapping("/api/tr-rcnr")
public class TrRCnrController {

    @Autowired
    private TrRCnrService trRCnrService;
    ...
    public ResponseEntity<?> convertExcelToXml(
        ...
        try {
            ...
            Document document = trRCnrService.processExcelFile(excelFile);
