...
import com.smi.declarations.services.DsService.DsIeSuiviService;
import com.smi.declarations.services.XsdValidator;
import com.smi.generated.ds_ie_suivi.Document;
...
@RestController
@RequestMapping("/api/ds-ie-suivi")
public class DsIeSuiviController {

    @Autowired
    private DsIeSuiviService dsIeSuiviService;
    ...
    public ResponseEntity<?> convertExcelToXml(
        ...
        try {
            ...
            Document document = dsIeSuiviService.processExcelFile(excelFile);
