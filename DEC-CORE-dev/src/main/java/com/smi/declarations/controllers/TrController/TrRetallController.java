...
import com.smi.declarations.services.TrService.TrRetallService;
import com.smi.declarations.services.XsdValidator;
import com.smi.generated.tr_retail.Document;
...
@RestController
@RequestMapping("/api/tr-retall")
public class TrRetallController {

    @Autowired
    private TrRetallService trRetallService;
    ...
    public ResponseEntity<?> convertExcelToXml(
        ...
        try {
            ...
            Document document = trRetallService.processExcelFile(excelFile);
