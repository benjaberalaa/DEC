...
import com.smi.declarations.services.TrService.TrSmService;
import com.smi.declarations.services.XsdValidator;
import com.smi.generated.tr_sm.Document;
...
@RestController
@RequestMapping("/api/tr-sm")
public class TrSmController {

    @Autowired
    private TrSmService trSmService;
    ...
    public ResponseEntity<?> convertExcelToXml(
        ...
        try {
            ...
            Document document = trSmService.processExcelFile(excelFile);
