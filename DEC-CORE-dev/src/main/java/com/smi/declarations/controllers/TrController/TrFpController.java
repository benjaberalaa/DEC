...
import com.smi.declarations.services.TrService.TrFpService;
import com.smi.declarations.services.XsdValidator;
import com.smi.generated.tr_fp.Document;
...
@RestController
@RequestMapping("/api/tr-fp")
public class TrFpController {

    @Autowired
    private TrFpService trFpService;
    ...
    public ResponseEntity<?> convertExcelToXml(
        ...
        try {
            ...
            Document document = trFpService.processExcelFile(excelFile);
