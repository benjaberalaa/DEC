...
import com.smi.declarations.services.DcService.DcMarService;
import com.smi.declarations.services.XsdValidator;
import com.smi.generated.dc_mar.Document;
...
@RestController
@RequestMapping("/api/dc-mar")
public class DcMarController {

    @Autowired
    private DcMarService dcMarService;
    ...
    public ResponseEntity<?> convertExcelToXml(
        ...
        try {
            ...
            Document document = dcMarService.processExcelFile(excelFile);
