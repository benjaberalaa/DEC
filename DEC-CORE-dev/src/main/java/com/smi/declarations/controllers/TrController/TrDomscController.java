...
import com.smi.declarations.services.TrService.TrDomscService;
import com.smi.declarations.services.XsdValidator;
import com.smi.generated.tr_domsc.Document;
...
@RestController
@RequestMapping("/api/tr-domsc")
public class TrDomscController {

    @Autowired
    private TrDomscService trDomscService;
    ...
    public ResponseEntity<?> convertExcelToXml(
        ...
        try {
            ...
            Document document = trDomscService.processExcelFile(excelFile);
