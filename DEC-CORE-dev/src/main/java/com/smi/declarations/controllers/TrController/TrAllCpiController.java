...
import com.smi.declarations.services.TrService.TrAllCpiService;
import com.smi.declarations.services.XsdValidator;
import com.smi.generated.tr_all_cpi.Document;
...
@RestController
@RequestMapping("/api/tr-all-cpi")
public class TrAllCpiController {

    @Autowired
    private TrAllCpiService trAllCpiService;
    ...
    public ResponseEntity<?> convertExcelToXml(
        ...
        try {
            ...
            Document document = trAllCpiService.processExcelFile(excelFile);
