package com.smi.declarations.controllers.DcController;

import com.smi.declarations.services.DcService.DcAvaService;
import com.smi.declarations.services.XsdValidator;
import com.smi.generated.dc_ava.Document;
...
@RestController
@RequestMapping("/api/dc-ava")
public class DcAvaController {

    @Autowired
    private DcAvaService dcAvaService;
    ...
    public ResponseEntity<?> convertExcelToXml(
        ...
        try {
            ...
            Document document = dcAvaService.processExcelFile(excelFile);
