...
import com.smi.generated.ds_stratup_ie_tr.*;
...
@Service
public class DsStartupIeTrService {

    private static final String CODE_ANNEXE = "DS-STARTUP-IE-TR";
    ...
    public Document processExcelFile(MultipartFile file) throws IOException {
        try (InputStream is = file.getInputStream();
            ...
            while (rowIterator.hasNext()) {
                ...
                documentInv.setCodDoc(getStringValue(dataRow.getCell(4))); // Colonne E: CodDoc (18 caractères)
