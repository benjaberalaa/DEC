...
import com.smi.generated.ds_ie_suivi.*;
...
@Service
public class DsIeSuiviService {

    private static final String CODE_ANNEXE = "DS-IE-SUIVI";
    ...
    public Document processExcelFile(MultipartFile file) throws IOException {
        try (InputStream is = file.getInputStream();
            ...
            while (rowIterator.hasNext()) {
                ...
                documentInv.setCodDoc(getStringValue(dataRow.getCell(4))); // Colonne E: CodDoc
